    ...
    private:
        ...
        void setup_menus() {
            ...
            Gtk::RadioButton *radiobutton_properties_menu =
                Gtk::make_managed<Gtk::RadioButton>(group_radiobuttons,
                                                    "Свойства");
            ...
            Gtk::RadioButton *radiobutton_zones_menu =
                Gtk::make_managed<Gtk::RadioButton>(group_radiobuttons, "Зоны");
            ...
            Gtk::RadioButton *radiobutton_arms_menu =
                Gtk::make_managed<Gtk::RadioButton>(group_radiobuttons, "АРМы");
