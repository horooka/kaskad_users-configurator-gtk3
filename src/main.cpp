...
class UserRightsConfigurator : public Gtk::Window {
    ...
    protected:
        ...
        void on_obj_selection_changed() {
            ...
            if (username.empty()) {
                radiobutton_statistics_menu.hide();
                if (curr_menu_idx == 3) {
                    radiobutton_arms_menu.set_active(true);
                    curr_menu_idx = 4;
                }
            }
        ...
        void on_settings_clicked() {
            ...
            vbox_settings_general->pack_start(*frame_general_user_auth_type,
                                              Gtk::PACK_SHRINK);
            Gtk::CheckButton *checkbutton_activedir_auth =
                Gtk::make_managed<Gtk::CheckButton>(
                    "Средствами Active Directory");
            Gtk::CheckButton *checkbutton_kscada_auth =
                Gtk::make_managed<Gtk::CheckButton>(
                    "Средствами SCADA системы \"Каскад\"");
            vbox_general_user_auth_type->pack_start(*checkbutton_activedir_auth,
                                                    Gtk::PACK_SHRINK);
            vbox_general_user_auth_type->pack_start(*checkbutton_kscada_auth,
                                                    Gtk::PACK_SHRINK);
            checkbutton_activedir_auth->signal_toggled().connect(
                [this, &checkbutton_activedir_auth,
                 &checkbutton_kscada_auth]() {
                    if (checkbutton_activedir_auth->get_active())
                        checkbutton_kscada_auth->set_active(false);
                    else if (!checkbutton_kscada_auth->get_active())
                        checkbutton_activedir_auth->set_active(true);
                });
            checkbutton_kscada_auth->signal_toggled().connect(
                [this, &checkbutton_kscada_auth,
                 &checkbutton_activedir_auth]() {
                    if (checkbutton_kscada_auth->get_active())
                        checkbutton_activedir_auth->set_active(false);
                    else if (!checkbutton_activedir_auth->get_active())
                        checkbutton_kscada_auth->set_active(true);
                });
            ...
            radiobutton_settings_general->signal_toggled().connect([&]() {
                radiobutton_settings_apps->get_style_context()->remove_class(
                    "selected-button");
                radiobutton_settings_general->get_style_context()->add_class(
                    "selected-button");
                stack_settings->set_visible_child(*vbox_settings_general);
            });
            radiobutton_settings_apps->signal_toggled().connect([&]() {
                radiobutton_settings_general->get_style_context()->remove_class(
                    "selected-button");
                radiobutton_settings_apps->get_style_context()->add_class(
                    "selected-button");
            ...
            main_settings.type_login =
                checkbutton_activedir_auth->get_active() ? 2 : 1;
            main_settings.ldap_server_name =
        ...
        void redraw_properties_menu() {
            ...
            for (int i = 0; i < 5; ++i) {
                if (i != 0) {
                    radiobuttons_form_buttons_bar[i]
                        ->get_style_context()
                        ->remove_class("selected-button");
                }
            }
            Glib::ustring username = curr_obj_row[obj_cols.username];
            ...
            radiobuttons_form_buttons_bar[0]->get_style_context()->add_class(
                "selected-button");
            curr_menu_idx = 0;
        }
        ...
        void redraw_actions_menu() {
            ...
            radiobuttons_form_buttons_bar[1]->get_style_context()->add_class(
                "selected-button");
            curr_menu_idx = 1;
        }
        ...
        void redraw_zones_menu() {
            ...
            radiobuttons_form_buttons_bar[2]->get_style_context()->add_class(
                "selected-button");
            curr_menu_idx = 2;
        }
        ...
        void redraw_statistics_menu() {
            ...
            radiobuttons_form_buttons_bar[3]->get_style_context()->add_class(
                "selected-button");
            curr_menu_idx = 3;
        }
        ...
        void redraw_arms_menu() {
            ...
            radiobuttons_form_buttons_bar[4]->get_style_context()->add_class(
                "selected-button");
            curr_menu_idx = 4;
        }
    ...
    private:
        void setup_ui() {
            ...
            vbox_form.pack_start(stack_menu, Gtk::PACK_EXPAND_WIDGET);
        ...
        void setup_menus() {
            ...
            radiobutton_properties_menu = Gtk::RadioButton(group, "Свойства");
            ...
            radiobutton_actions_menu = Gtk::RadioButton(group, "Действия");
            ...
            radiobutton_zones_menu = Gtk::RadioButton(group, "Зоны");
            ...
            radiobutton_statistics_menu = Gtk::RadioButton(group, "Статистика");
            ...
            radiobutton_arms_menu = Gtk::RadioButton(group, "АРМы");
        ...
        Gtk::RadioButton radiobutton_properties_menu, radiobutton_actions_menu,
            radiobutton_zones_menu, radiobutton_statistics_menu,
            radiobutton_arms_menu;
