    ...
    private:
        ...
        void EnsureCapacity(size_t cap) {
            ...
            if (cap > _allocated) {
                ...
                memcpy(newMem, _mem,
                       sizeof(T) * _size); // warning: not using constructors,
                                           // only works for PODs
                if (_mem != _pool) {
                    delete[] _mem;
                }
...
template <size_t ITEM_SIZE> class MemPoolT : public MemPool {
    public:
        MemPoolT()
            : _blockPtrs(), _root(0), _currentAllocs(0), _nAllocs(0),
              _maxAllocs(0), _nUntracked(0) {}
...
class TINYXML2_LIB XMLNode {
    ...
    public:
        ...
        // ChildElementCount was originally suggested by msteiger on the
        // sourceforge page for TinyXML and modified by KB1SPH for TinyXML-2.
        ...
        */
        ...
        /// Gets the line number the node is in, if the document was parsed from
        /// a file.
        ...
        */
        ...
        /// Get the previous (left) sibling element of this node, with an
        /// optionally supplied name.
        const XMLElement *PreviousSiblingElement(const char *name = 0) const;

        XMLElement *PreviousSiblingElement(const char *name = 0) {
            return const_cast<XMLElement *>(
                const_cast<const XMLNode *>(this)->PreviousSiblingElement(
                    name));
        }
        ...
        /// Get the next (right) sibling element of this node, with an
        /// optionally supplied name.
        ...
        */
        ...
        /** Accept a hierarchical visit of the nodes in the TinyXML-2 DOM. Every
           node in the XML tree will be conditionally visited and the host will
           be called back via the XMLVisitor interface.
...
class TINYXML2_LIB XMLAttribute {
    ...
    public:
        ...
        /** IntValue interprets the attribute as an integer, and returns the
           value. If the value isn't an integer, 0 will be returned. There is no
           error checking; use QueryIntValue() if you need error checking.
        */
        int IntValue() const {
            int i = 0;
            QueryIntValue(&i);
        ...
        /** QueryIntValue interprets the attribute as an integer, and returns
           the value in the provided parameter. The function will return
           XML_SUCCESS on success, and XML_WRONG_ATTRIBUTE_TYPE if the
    ...
    public:
        ...
        */
        ...
        /** Convenience function for easy access to the text inside an element.
           Although easy and concise, GetText() is limited compared to getting
           the XMLText child and accessing it directly.
        ...
        */
        ...
        /** Convenience function for easy access to the text inside an element.
           Although easy and concise, SetText() is limited compared to creating
           an XMLText child and mutating it directly.

            If the first child of 'this' is a XMLText, SetText() sets its value
           to the given string, otherwise it will create a first child that is
           an XMLText.
           ...
           created from this XML:
            ...
            then it will not change "This is text", but rather prefix it with a
           text element:
            @verbatim
        ...
        */
        ...
        /// Convenience method for setting text inside an element. See SetText()
        ...
        /**
           ...
           probably best shown by example. Given you have a document is this
           form:
            @verbatim
                <point>
                    <x>1</x>
            ...
            The QueryIntText() and similar functions provide a safe and easier
           way to get to the "value" of x and y.
           ...
           "y" ); xElement->QueryIntText( &x ); yElement->QueryFloatText( &y );
            @endverbatim

            @returns XML_SUCCESS (0) on success, XML_CAN_NOT_CONVERT_TEXT if the
           text cannot be converted to the requested type, and XML_NO_TEXT_NODE
           if there is no child text to query.
        ...
        */
        ...
        /**
            Convenience method to create a new XMLElement and add it as last
           (right) child of this node. Returns the created and inserted element.
        */
...
class TINYXML2_LIB XMLDocument : public XMLNode {
    ...
    public:
        ...
        */
        ...
        virtual XMLNode *
        ShallowClone(XMLDocument * /*document*/) const override {
            return 0;
        }
        virtual bool ShallowEqual(const XMLNode * /*compare*/) const override {
            return false;
...
class TINYXML2_LIB XMLHandle {
    public:
        /// Create a handle from any node (at any depth of the tree.) This can
        /// be a null pointer.
...
class TINYXML2_LIB XMLConstHandle {
    public:
        ...
        PreviousSiblingElement(const char *name = 0) const {
            return XMLConstHandle(_node ? _node->PreviousSiblingElement(name)
                                        : 0);
        }
...
class TINYXML2_LIB XMLPrinter : public XMLVisitor {
    ...
    protected:
        ...
        /** Prints out the space before an element. You may override to change
            the space and tabs used. A PrintSpace() override should call
           Print().
        */
    ...
    private:
        /**
           Prepares to write a new node. This includes sealing an element that
           was just opened, and writing any whitespace necessary if not in
           compact mode.
         */
